...
class top_block(gr.top_block):
    ...
    def __init__(self, options):
        ...
        if options.bits == 16:
            ...
            self.blocks_file_source = blocks.file_source(gr.sizeof_short*1, options.filename, repeat)
            ...
            # a file source for the file generated by the gps-sdr-sim
            self.blocks_file_source = blocks.file_source(gr.sizeof_char*1, options.filename, repeat)
...
def get_options():
    ...
    parser.add_option("-r", "--repeat", action="store_true", dest="repeat",
                      help="Select to repeat the play file")
